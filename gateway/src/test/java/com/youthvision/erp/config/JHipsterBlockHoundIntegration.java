package com.youthvision.erp.config;
...
public class JHipsterBlockHoundIntegration implements BlockHoundIntegration {
    ...
    public void applyTo(BlockHound.Builder builder) {
        ...
        builder.allowBlockingCallsInside("com.youthvision.erp.service.MailService", "sendEmailFromTemplate");
        builder.allowBlockingCallsInside("com.youthvision.erp.security.DomainUserDetailsService", "createSpringSecurityUser");
